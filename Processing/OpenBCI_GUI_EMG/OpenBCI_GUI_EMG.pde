...
/* VARIATION -- CODE FOR BCI MONTREAL / HACK THE BRAIN AMSTERDAM JOINT TRANSATLANTIC BIODATA COMMUNICATION CONNECTION AWESOME HACK 
      * Challenge Information: http://openbci.com/community/?challenge=transatlantic-biodata
      * 6/4/15-6/7/15
*/
...
import processing.net.*; //added this to import Client Class

// Variables for TCP Client / Server
Client c;
...
// Set netBridge serial parameters
//String netBridge_portName = "/dev/tty.usbmodemfd131";  //must edit this based on the name of the serial/COM port your HHI Arduino is connected to
//Serial netBridge_serial;
//int netBridge_baud = 115200; //baud rate from the Arduino

//fft constants
int Nfft = 256; //set resolution of the FFT.  Use N=256 for normal, N=512 for MU waves
FFT fftBuff[] = new FFT[nchan];   //from the minim library
float[] smoothFac = new float[] {
  0.75, 0.9, 0.95, 0.98, 0.0, 0.5
};
